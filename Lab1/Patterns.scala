...
object Patterns extends App {
  ...
  println(testIsMaxAndMoritz("Maxi"))
  ...
  println(TestExtractMammalWeight(Mammal("Seva", Meat, 85)))
  println(TestExtractMammalWeight(Mammal("Seva", Meat, 85)))
  ...
  println(testUpdateFood(Bird("Vsevolod", Meat)))
  println(testUpdateFood(Fish("Volkogonov", Meat)))
}